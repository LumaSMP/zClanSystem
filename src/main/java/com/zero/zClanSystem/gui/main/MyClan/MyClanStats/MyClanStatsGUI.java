...
public class MyClanStatsGUI {

    public static final String TITLE_PREFIX = "§8My Clan Stats ";

    private final ClanManager clanManager;
    private final Clan clan;

    public MyClanStatsGUI(ClanManager clanManager, Clan clan) {
    ...
    public void open(Player player) {
        ...
        Inventory inv = Bukkit.createInventory(
                new GUIHolder(GUIType.MY_CLAN_STATS, clan),
                27,
                title
        );
